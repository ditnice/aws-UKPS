...
export const fakeGetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsRequest = (options?: Options): Omit<GetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsData, 'url'> => {
    const f = options?.faker ?? faker;
    return {
        path: {
            organisationId: f.number.int(),
...
export const fakeGetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsResponse200 = (options?: Options): GetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsResponses[200] => fakeUserMembershipRequestDto(options);

export const fakeGetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsResponse403 = (options?: Options): GetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsErrors[403] => fakeProblemDetails(options);

export const fakeGetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsResponse404 = (options?: Options): GetOrganisationsByOrganisationIdUsersByUserIdMembershipRequestsErrors[404] => fakeProblemDetails(options);
