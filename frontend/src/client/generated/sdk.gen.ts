 ...
 */
export const membershipRequestApprove = <ThrowOnError extends boolean = false>(options: Options<MembershipRequestApproveData, ThrowOnError>): RequestResult<MembershipRequestApproveResponses, MembershipRequestApproveErrors, ThrowOnError> => (options.client ?? client).patch<MembershipRequestApproveResponses, MembershipRequestApproveErrors, ThrowOnError>({ url: '/organisations/{organisationId}/users/{userId}/membership-requests/approve', ...options });
