 ...
 */
export const getOrganisations = <ThrowOnError extends boolean = false>(options?: Options<GetOrganisationsData, ThrowOnError>): RequestResult<GetOrganisationsResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetOrganisationsResponses, unknown, ThrowOnError>({ url: '/organisations', ...options });
