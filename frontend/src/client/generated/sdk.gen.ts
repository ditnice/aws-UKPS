 ...
 */
export const getOrganisationsPublicOptions = <ThrowOnError extends boolean = false>(options?: Options<GetOrganisationsPublicOptionsData, ThrowOnError>): RequestResult<GetOrganisationsPublicOptionsResponses, GetOrganisationsPublicOptionsErrors, ThrowOnError> => (options?.client ?? client).get<GetOrganisationsPublicOptionsResponses, GetOrganisationsPublicOptionsErrors, ThrowOnError>({ url: '/organisations/publicOptions', ...options });
