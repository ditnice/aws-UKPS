...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_text_section_variant" AS ENUM('default', 'homeStandard');
  CREATE TYPE "public"."enum_pages_blocks_column_list_columns" AS ENUM('2', '3');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_text_section_variant" AS ENUM('default', 'homeStandard');
  CREATE TYPE "public"."enum__pages_v_blocks_column_list_columns" AS ENUM('2', '3');
  ...
  CREATE TABLE "pages_blocks_text_section" (
  	...
  	"heading" varchar,
  	"body" varchar,
  	"variant" "enum_pages_blocks_text_section_variant" DEFAULT 'default',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_column_list_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar
  ...
  CREATE TABLE "pages_blocks_column_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"columns" "enum_pages_blocks_column_list_columns",
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_text_section" (
  	...
  	"heading" varchar,
  	"body" varchar,
  	"variant" "enum__pages_v_blocks_text_section_variant" DEFAULT 'default',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_column_list_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_column_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"columns" "enum__pages_v_blocks_column_list_columns",
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "header_header_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "pages_blocks_column_list_items" ADD CONSTRAINT "pages_blocks_column_list_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_column_list"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_column_list" ADD CONSTRAINT "pages_blocks_column_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_column_list_items" ADD CONSTRAINT "_pages_v_blocks_column_list_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_column_list"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_column_list" ADD CONSTRAINT "_pages_v_blocks_column_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "header_header_links" ADD CONSTRAINT "header_header_links_destination_id_pages_id_fk" FOREIGN KEY ("destination_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "header_header_links" ADD CONSTRAINT "header_header_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_column_list_items_order_idx" ON "pages_blocks_column_list_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_column_list_items_parent_id_idx" ON "pages_blocks_column_list_items" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_column_list_order_idx" ON "pages_blocks_column_list" USING btree ("_order");
  CREATE INDEX "pages_blocks_column_list_parent_id_idx" ON "pages_blocks_column_list" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_column_list_path_idx" ON "pages_blocks_column_list" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_column_list_items_order_idx" ON "_pages_v_blocks_column_list_items" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_column_list_items_parent_id_idx" ON "_pages_v_blocks_column_list_items" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_column_list_order_idx" ON "_pages_v_blocks_column_list" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_column_list_parent_id_idx" ON "_pages_v_blocks_column_list" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_column_list_path_idx" ON "_pages_v_blocks_column_list" USING btree ("_path");
  ...
  CREATE INDEX "header_header_links_order_idx" ON "header_header_links" USING btree ("_order");
  CREATE INDEX "header_header_links_parent_id_idx" ON "header_header_links" USING btree ("_parent_id");
  CREATE INDEX "header_header_links_destination_idx" ON "header_header_links" USING btree ("destination_id");`)
}
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_column_list_items" CASCADE;
  DROP TABLE "pages_blocks_column_list" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_column_list_items" CASCADE;
  DROP TABLE "_pages_v_blocks_column_list" CASCADE;
  ...
  DROP TABLE "header_header_links" CASCADE;
  DROP TABLE "header" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_text_section_variant";
  DROP TYPE "public"."enum_pages_blocks_column_list_columns";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_blocks_text_section_variant";
  DROP TYPE "public"."enum__pages_v_blocks_column_list_columns";
