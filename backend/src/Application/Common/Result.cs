...
/// <summary>
/// Represents the result of an operation that either succeeds or fails with an error of type
    ...
    where TError : notnull
{
    ...
    {
        return new Result<TError>(default, isOk: true);
    }
    ...
    public static Result<TError> Err(TError error)
    {
        ArgumentNullException.ThrowIfNull(error);

        return new Result<TError>(error, isOk: false);
    }
    ...
    public TResult Match<TResult>(Func<TResult> onOk, Func<TError, TResult> onErr)
    {
...
[StructLayout(LayoutKind.Auto)]
public readonly record struct Result<TValue, TError> : IResult<TError>
