...
// // [Fact] // moved to service tests but here for now
// //     public async Task CreateOrganisation_AllFieldsProvided_ReturnsDto()
// //     {
// //         OrganisationDetailsDto expected = CreateOrganisationDetailsDto();
// //         _organisationServiceMock
// //             .CreateOrganisation(Arg.Any<CreateOrganisationDto>())
// //             .Returns(Result<OrganisationDetailsDto,CreateOrganisationError>.Ok(expected));
...
//     [Fact]
//     public async Task CreateOrganisation_MissingFields_ReturnsBadRequest()
//     {
//         _organisationServiceMock
//             .CreateOrganisation(Arg.Any<CreateOrganisationDto>())
//             .Returns(
...
//         // BadRequestObjectResult badRequest = result.Result.ShouldBeOfType<BadRequestObjectResult>();
//         // badRequest.Value.ShouldBe("Some of the data required is missing.");
//     }
