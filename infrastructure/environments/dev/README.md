...
| <a name="input_migrator_image_repository_url"></a> [migrator\_image\_repository\_url](#input\_migrator\_image\_repository\_url) | Container image repository URL for the database migration Lambda, without an image tag or digest | `string` | n/a | yes |
