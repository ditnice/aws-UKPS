...
output "frontend_aurora_endpoint" {
  description = "Test Aurora writer endpoint"
...
output "frontend_host_name" {
  description = "Frontend hostname routed by the test ALB listener"
  value       = module.alb.frontend_host_name
}

output "backend_host_name" {
  description = "Backend hostname routed by the test ALB listener"
...
output "cognito_user_pool_arn" {
  description = "ARN of the test Cognito user pool"
  value       = module.cognito.user_pool_arn
}

output "cognito_app_client_id" {
  description = "ID of the test Cognito backend app client"
  value       = module.cognito.app_client_id
}

output "cognito_user_pool_issuer" {
  description = "OIDC issuer URL of the test Cognito user pool"
