...
| [aws_iam_role_policy_attachment.additional_execution_role_policies](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.additional_task_role_policies](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_container_environment"></a> [container\_environment](#input\_container\_environment) | Non-sensitive environment variables passed to the application container | `map(string)` | `{}` | no |
...
| <a name="input_container_secrets"></a> [container\_secrets](#input\_container\_secrets) | Map of container environment variable names to Secrets Manager secret ARNs | `map(string)` | `{}` | no |
...
| <a name="input_execution_role_policy_arns"></a> [execution\_role\_policy\_arns](#input\_execution\_role\_policy\_arns) | Map of stable policy names to additional IAM policy ARNs for the ECS task execution role | `map(string)` | `{}` | no |
...
| <a name="input_task_role_policy_arns"></a> [task\_role\_policy\_arns](#input\_task\_role\_policy\_arns) | Map of stable policy names to additional IAM policy ARNs for the ECS task role | `map(string)` | `{}` | no |
