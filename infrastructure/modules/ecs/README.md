...
| <a name="input_cloudwatch_log_retention"></a> [cloudwatch\_log\_retention](#input\_cloudwatch\_log\_retention) | The number of days to retain the logs in CloudWatch | `number` | `30` | no |
...
| <a name="input_ecs_capacity_providers"></a> [ecs\_capacity\_providers](#input\_ecs\_capacity\_providers) | A list of capacity providers to use for the ECS cluster | `list(any)` | <pre>[<br/>  "FARGATE"<br/>]</pre> | no |
...
| <a name="input_environment"></a> [environment](#input\_environment) | The environment to deploy to (e.g. dev, staging, prod) | `string` | n/a | yes |
