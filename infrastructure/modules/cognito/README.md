...
| <a name="input_ses_configuration_set_name"></a> [ses\_configuration\_set\_name](#input\_ses\_configuration\_set\_name) | Name of the SES configuration set used for authentication email | `string` | n/a | yes |
